...
_camera camPreparePos (getPos intro_3);
_camera camCommitPrepared 0;
private _vectorDir = vectorDir intro_3;
private _vectorUp = vectorUp intro_3;
...
[_camera, [vectorDir intro_4, vectorUp intro_4], _duration, 2, 5] call GRAD_INTRO_fnc_camTilt;
