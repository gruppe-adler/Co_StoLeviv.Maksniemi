...

{
	...
	private _weaponholder = ["Item_rhs_weap_m38", getPosATL _x, 1, true] call grad_loot_fnc_createLoot;
	...
	_actionDummy setVariable ["grad_loot_weaponholder", _weaponholder, true];
