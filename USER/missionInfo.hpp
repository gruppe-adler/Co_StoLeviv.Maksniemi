...
onLoadName = "Co Sto Leviv";                                                    // Name der Mission
onLoadMission = "Each player starts on his own.";                               // Beschreibung der Mission (wird im Ladebildschirm unterhalb des Ladebildes angezeigt)
