...
[{!isNull player}, {
    ...
    _action = ["GRAD_leaveNotes_mainGiveAction", "Give note", "node_modules\grad-leaveNotes\data\give.paa", {}, {(player getVariable ["GRAD_leaveNotes_notesInInventory", 0]) > 0}] call ace_interact_menu_fnc_createAction;
